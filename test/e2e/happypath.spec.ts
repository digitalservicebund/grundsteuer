...
describe("Happy Path", () => {
  it("Enter data for two eigentuemer", () => {
    ...
    cy.get("#grundbuchblattnummer").should(
      "have.value",
      inputData.grundstueck.flurstueck.angaben.grundbuchblattnummer
    );
    cy.get("#gemarkung").should(
      "have.value",
      inputData.grundstueck.flurstueck.angaben.gemarkung
    );
    cy.get("#flur").should(
      "have.value",
      inputData.grundstueck.flurstueck.angaben.flur
    );
    cy.get("#flurstueckZaehler").should(
      "have.value",
      inputData.grundstueck.flurstueck.angaben.flurstueckZaehler
    );
    cy.get("#flurstueckNenner").should(
      "have.value",
      inputData.grundstueck.flurstueck.angaben.flurstueckNenner
    );
    cy.get("#wirtschaftlicheEinheitZaehler").should(
      "have.value",
      inputData.grundstueck.flurstueck.angaben.wirtschaftlicheEinheitZaehler
    );
    cy.get("#wirtschaftlicheEinheitNenner").should(
      "have.value",
      inputData.grundstueck.flurstueck.angaben.wirtschaftlicheEinheitNenner
    );
    cy.get("#groesseHa").should(
      "have.value",
      inputData.grundstueck.flurstueck.angaben.groesseHa
    );
    cy.get("#groesseA").should(
      "have.value",
