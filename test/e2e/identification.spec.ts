...
describe("menu item Identifikation", () => {
  ...
  it("should redirect to identification overview page on unidentified user with no FSC request", () => {
    cy.login();
    cy.visit("/formular");
  ...
  it("should redirect to /identifikation/erfolgreich on identified user", () => {
