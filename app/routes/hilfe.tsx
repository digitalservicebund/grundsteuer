      ...
      <main className="flex-grow">
        <ContentContainer>
          ...
          <ContentContainer size="sm-md" className="mb-32 md:mb-48">
            <Hint>
              <strong>Bitte beachten Sie:</strong> Wir beantworten
              ausschließlich Fragen zum Produkt Grundsteuererklärung für
              Privateigentum.
            </Hint>
          </ContentContainer>
            ...
            >
              <ContentContainer size="md">
                <h2 className="text-24 leading-30 md:text-30 md:leading-36 mb-24">
                  ...
                  persönlichen Sachverhalt, möchten wir Sie auf die
                  umfangreichen Hilfe-Seiten der Bundesländer verweisen.
                </h2>
              </ContentContainer>
            ...
            >
              ...
              <ContentContainer size="sm" className="text-16 leading-26 mb-24">
                ...
                <ul className="list-disc pl-24 mb-8">
                  ...
                  <li>
                    Brauche ich einen Elster-Account für den Online-Dienst?
                  </li>
                  <li>
                    Ich habe ein Problem beim Ausfüllen des Online-Formulars.
                    Was kann ich tun?
                  </li>
                </ul>
              ...
              <ContentContainer size="sm-md">
                <p className="pt-24 text-16 leading-26">
                  ...
                  einen passenden Betreff. Das erleichtert uns die Bearbeitung
                  der Anfragen. Ihre E-Mail wird ausschließlich zur Beantwortung
                  Ihrer Anfrage verarbeitet und gespeichert.
                </p>
              </ContentContainer>
            </div>
          </ContentContainer>
