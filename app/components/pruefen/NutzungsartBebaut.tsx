      ...
      <>
        ...
        <ul className="mb-8 ml-20 list-disc">
          <li>
            ...
            werden nicht genutzt/Wirtschaftsgebäude stehen leer oder sind
            ungenutzt
          </li>
          <li>
          ...
          <li>
            ...
            Flächen/leerstehende Wirtschaftsgebäude sollen bis zum Jahr 2029
            wieder wirtschaftlich genutzt werden
          </li>
        </ul>
      </>
    ),
