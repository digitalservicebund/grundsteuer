  ...
  return (
    <>
      ...
      <div className="mb-80">
        <EnumeratedCard
          image={rp1}
          imageAltText="Bildbeispiel des Datenstammblatts Rheinland-Pfalz für Schritt 1"
          number="1"
        ...
        <EnumeratedCard
          image={rp2}
          imageAltText="Bildbeispiel des Datenstammblatts Rheinland-Pfalz für Schritt 2"
          number="2"
