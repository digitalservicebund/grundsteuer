  ...
  return (
    <>
      ...
      <div className="mb-80">
        <EnumeratedCard
          image={sh1}
          imageAltText="Kartenausschnitt von Schritt 1 des Grundsteuerportals Schleswig-Holstein"
          number="1"
          heading="Externe Seite öffnen und Adresse eingeben"
          text="Öffnen Sie den oben stehenden Link. Geben Sie in die Suchleiste oben links Ihre Grundstücksadresse ein."
          className="mb-16"
        />
        <EnumeratedCard
          image={sh2}
          imageAltText="Kartenausschnitt von Schritt 2 des Grundsteuerportals Schleswig-Holstein"
          number="2"
          heading="Kartenausschnitt"
          text="Der Kartenausschnitt zeigt nun Ihr Grundstück an. Die roten Linien markieren die Grenze des Bodenrichtwerts. Wenn Sie den Kartenausschnitt vergrößern, werden auch die Flurstücke in Gelb dargestellt. Klicken Sie auf das rote Symbol, das Ihr Grundstück markiert. "
          className="mb-16"
        />
        <EnumeratedCard
          image={sh3}
          imageAltText="Kartenausschnitt von Schritt 3 des Grundsteuerportals Schleswig-Holstein"
          number="3"
        ...
        <EnumeratedCard
          image={sh4}
          imageAltText="Kartenausschnitt von Schritt 4 des Grundsteuerportals Schleswig-Holstein"
          number="4"
