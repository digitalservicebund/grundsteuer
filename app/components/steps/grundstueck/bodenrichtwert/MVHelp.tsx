...
export const MVHelp = () => {
  return (
    <>
      <EnumeratedCard
        image={mvp1}
        imageAltText="Bildbeispiel von Schritt 1 des Bodenrichtwert-Portal Mecklenburg-Vorpommern"
        number="1"
      ...
      <EnumeratedCard
        image={mvp2}
        imageAltText="Bildbeispiel von Schritt 2 des Bodenrichtwert-Portal Mecklenburg-Vorpommern"
        number="2"
      ...
      <EnumeratedCard
        image={mvp3}
        imageAltText="Bildbeispiel von Schritt 3 des Bodenrichtwert-Portal Mecklenburg-Vorpommern"
        number="3"
      ...
      <EnumeratedCard
        image={mvp4}
        imageAltText="Bildbeispiel von Schritt 4 des Bodenrichtwert-Portal Mecklenburg-Vorpommern"
        number="4"
        heading="PDF abrufen"
      ...
      <EnumeratedCard
        image={mvp5}
        imageAltText="Bildbeispiel von Schritt 5 des Bodenrichtwert-Portal Mecklenburg-Vorpommern"
        number="5"
