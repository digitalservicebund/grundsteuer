...
flags=("grundsteuer.bundesident_disabled" "grundsteuer.bundesident_down" "grundsteuer.ekona_down" "grundsteuer.erica_down" "grundsteuer.grundsteuer_down" "grundsteuer.sendinblue_down" "grundsteuer.zammad_down")
